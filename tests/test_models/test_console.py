...
class TestHBNBCommand_prompting(unittest.TestCase):
    ...
    def test_empty_line(self):
        with patch("sys.stdout", new=StringIO()) as kd_output:
            self.assertFalse(HBNBCommand().onecmd(""))
            self.assertEqual("", kd_output.getvalue().strip())
...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_quit(self):
        ...
        with patch("sys.stdout", new=StringIO()) as kd_output:
            ...
            self.assertEqual(h, kd_output.getvalue().strip())
...
class TestHBNBCommand_create(unittest.TestCase):
    ...
    def test_create_missing_class(self):
        ...
        with patch("sys.stdout", new=StringIO()) as kd_output:
            ...
            self.assertEqual(correct, kd_output.getvalue().strip())
    ...
    def test_create_object(self):
        with patch("sys.stdout", new=StringIO()) as kd_output:
            ...
            self.assertLess(0, len(kd_output.getvalue().strip()))
            testKey = "BaseModel.{}".format(kd_output.getvalue().strip())
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as kd_output:
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertLess(0, len(kd_output.getvalue().strip()))
            testKey = "User.{}".format(kd_output.getvalue().strip())
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as kd_output:
            self.assertFalse(HBNBCommand().onecmd("create State"))
            self.assertLess(0, len(kd_output.getvalue().strip()))
            testKey = "State.{}".format(kd_output.getvalue().strip())
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as kd_output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
            self.assertLess(0, len(kd_output.getvalue().strip()))
            testKey = "City.{}".format(kd_output.getvalue().strip())
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as kd_output:
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
            self.assertLess(0, len(kd_output.getvalue().strip()))
            testKey = "Amenity.{}".format(kd_output.getvalue().strip())
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as kd_output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
            self.assertLess(0, len(kd_output.getvalue().strip()))
            testKey = "Place.{}".format(kd_output.getvalue().strip())
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as kd_output:
            self.assertFalse(HBNBCommand().onecmd("create Review"))
            self.assertLess(0, len(kd_output.getvalue().strip()))
            testKey = "Review.{}".format(kd_output.getvalue().strip())
            self.assertIn(testKey, storage.all().keys())
...
class TestHBNBCommand_show(unittest.TestCase):
    ...
    def test_show_objects_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as kd_output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testID = kd_output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as kd_output:
            obj = storage.all()["BaseModel.{}".format(testID)]
            command = "show BaseModel {}".format(testID)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertEqual(obj.__str__(), kd_output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as kd_output:
            self.assertFalse(HBNBCommand().onecmd("create User"))
            testID = kd_output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as kd_output:
...
class TestHBNBCommand_all(unittest.TestCase):
    ...
    def test_all_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as kd_output:
            ...
            self.assertIn("BaseModel", kd_output.getvalue().strip())
            self.assertIn("User", kd_output.getvalue().strip())
            self.assertIn("State", kd_output.getvalue().strip())
            self.assertIn("Place", kd_output.getvalue().strip())
            self.assertIn("City", kd_output.getvalue().strip())
            self.assertIn("Amenity", kd_output.getvalue().strip())
            self.assertIn("Review", kd_output.getvalue().strip())
    ...
    def test_all_single_object_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as kd_output:
            ...
            self.assertIn("BaseModel", kd_output.getvalue().strip())
            self.assertNotIn("User", kd_output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as kd_output:
            self.assertFalse(HBNBCommand().onecmd("all User"))
            self.assertIn("User", kd_output.getvalue().strip())
            self.assertNotIn("BaseModel", kd_output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as kd_output:
...
class TestHBNBCommand_count(unittest.TestCase):
    ...
    def test_count_invalid_class(self):
        with patch("sys.stdout", new=StringIO()) as kd_output:
            ...
            self.assertEqual("0", kd_output.getvalue().strip())
    ...
    def test_count_object(self):
        ...
        with patch("sys.stdout", new=StringIO()) as kd_output:
            ...
            self.assertEqual("1", kd_output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as kd_output:
            self.assertFalse(HBNBCommand().onecmd("create User"))
        with patch("sys.stdout", new=StringIO()) as kd_output:
